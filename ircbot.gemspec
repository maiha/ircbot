...
Gem::Specification.new do |s|
  ...
  s.files = ["MIT-LICENSE", "README", "Rakefile", "lib/ircbot", "lib/ircbot/dm.rb", "lib/ircbot/framework.rb", "lib/ircbot/client.rb", "lib/ircbot/client", "lib/ircbot/client/config.rb", "lib/ircbot/client/config", "lib/ircbot/client/config/channels.rb", "lib/ircbot/client/config/plugins.rb", "lib/ircbot/client/config/generator.rb", "lib/ircbot/client/encoding.rb", "lib/ircbot/client/core.rb", "lib/ircbot/client/commands.rb", "lib/ircbot/client/standalone.rb", "lib/ircbot/client/plugins.rb", "lib/ircbot/client/logger.rb", "lib/ircbot/client/eventable.rb", "lib/ircbot/client/timeout.rb", "lib/ircbot/core_ext", "lib/ircbot/core_ext/extending.rb", "lib/ircbot/core_ext/message.rb", "lib/ircbot/core_ext/delegation.rb", "lib/ircbot/plugins.rb", "lib/ircbot/version.rb", "lib/ircbot/plugin.rb", "lib/ircbot.rb", "spec/config_spec.rb", "spec/plugins", "spec/plugins/youtube", "spec/plugins/youtube/watch.html", "spec/plugins/youtube/youtube_spec.rb", "spec/plugin_spec.rb", "spec/provide_helper.rb", "spec/fixtures", "spec/fixtures/sama-zu.yml", "spec/its_helper.rb", "spec/spec_helper.rb", "spec/framework_spec.rb", "spec/plugins_spec.rb", "plugins/tv.rb", "plugins/reminder.rb", "plugins/youtube.rb", "plugins/echo.rb", "plugins/plugins.rb", "plugins/which.rb", "plugins/irc.rb", "config/sama-zu.yml", "config/yml.erb", "bin/ircbot"]
